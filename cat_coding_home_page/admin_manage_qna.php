        ...
        <div id="admin_box">
            ...
            <ul id="board_list">
                <li class="title">
                    ...
                    <span class="col444">제목</span>
                    <span class="col6">작성날짜</span>
                </li>

                <form method="post" action="admin_qna_delete.php">
            ...
            <?php
                if ($total_page >=2 && $page >= 2) {
                    $new_page = $page - 1;
                    echo "<li><a href='admin_manage_qna.php?page=$new_page'>◀ 이전&nbsp</a></li>";
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    ...
                    if ($page == $i) {
                        ...
                        echo "<li><a href='admin_manage_qna.php?page=$i'> &nbsp$i&nbsp </a></li>";
                    }
                }
                ...
                if ($total_page >= 2 && $page != $total_page) {
                    ...
                    $new_page = $page + 1;
                    echo "<li><a href='admin_manage_qna.php?page=$new_page'>다음 ▶&nbsp</a></li>";
